  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='jiaolian'" label='头像' prop="jiaolianPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='jiaolian'"  label='联系方式' prop="jiaolianPhone">
               <el-input v-model="ruleForm.jiaolianPhone"  placeholder='联系方式' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='jiaolian'"  label='邮箱' prop="jiaolianEmail">
               <el-input v-model="ruleForm.jiaolianEmail"  placeholder='邮箱' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='jiaolian'"  label='擅长项目' prop="jiaolianXiangmu">
               <el-input v-model="ruleForm.jiaolianXiangmu"  placeholder='擅长项目' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='jiaolian'"  label='获得奖项' prop="jiaolianJiangxiang">
               <el-input v-model="ruleForm.jiaolianJiangxiang"  placeholder='获得奖项' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="24">
             <el-form-item v-if="flag=='jiaolian'"  label="教练简介" prop="jiaolianContent">
                 <editor
                         style="min-width: 200px; max-width: 600px;"
                         v-model="ruleForm.jiaolianContent"
                         class="editor"
                         action="file/upload">
                 </editor>
             </el-form-item>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='会员类型' prop="huanyuanTypes">
                 <el-select v-model="ruleForm.huanyuanTypes" readonly placeholder='请选择会员类型'>
                     <el-option
                             v-for="(item,index) in huanyuanTypesOptions"
...
// 注册表 教练 的级联表
   ...
   this.$http({
       url: `dictionary/page?page=1&limit=100&sort=&order=&dicCode=huanyuan_types`,
       method: "get"
   }).then(({ data }) => {
       if (data && data.code === 0) {
          this.huanyuanTypesOptions = data.data.list;
      } else {
          this.$message.error(data.msg);
      }
    });
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.jiaolianPhone)&& 'jiaolian'==this.flag){
                         ...
                         if((!this.ruleForm.jiaolianXiangmu)&& 'jiaolian'==this.flag){
                             this.$message.error('擅长项目不能为空');
                             return
                         }

                         if((!this.ruleForm.jiaolianJiangxiang)&& 'jiaolian'==this.flag){
                             this.$message.error('获得奖项不能为空');
                             return
                         }

                         if((!this.ruleForm.jiaolianContent)&& 'jiaolian'==this.flag){
                             this.$message.error('教练简介不能为空');
                             return
                         }
                         ...
                         if((!this.ruleForm.huanyuanTypes)&& 'yonghu'==this.flag){
