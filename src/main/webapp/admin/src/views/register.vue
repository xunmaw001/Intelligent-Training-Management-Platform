<template>
    <div style="backgroundImage: url('/zhinengxunlianpingtai/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">智能训练管理平台注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="教练姓名" class="input" v-if="tableName=='jiaolian'">
                            <el-input v-model="ruleForm.jiaolianName" autocomplete="off" placeholder="教练姓名"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='jiaolian'">
                            <el-input v-model="ruleForm.jiaolianPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='jiaolian'">
                            <el-input v-model="ruleForm.jiaolianEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.jiaolianName)&& 'jiaolian'==this.tableName){
                                this.$message.error('教练姓名不能为空');
                                return
                            }
                             if('jiaolian' == this.tableName && this.ruleForm.jiaolianPhone&&(!this.$validate.isMobile(this.ruleForm.jiaolianPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('jiaolian' == this.tableName && this.ruleForm.jiaolianEmail&&(!this.$validate.isEmail(this.ruleForm.jiaolianEmail))){
