        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="会员类型" prop="huanyuanTypes">
                        <el-select v-model="ruleForm.huanyuanTypes" :disabled="ro.huanyuanTypes" placeholder="请选择会员类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="会员类型" prop="huanyuanValue">
                        <el-input v-model="ruleForm.huanyuanValue"
                            placeholder="会员类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="会员到期时间" prop="huiyuandaoqiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.huiyuandaoqiTime"
                                type="datetime"
                                placeholder="会员到期时间"
                                :disabled="ro.huiyuandaoqiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.huiyuandaoqiTime" label="会员到期时间" prop="huiyuandaoqiTime">
                            <span v-html="ruleForm.huiyuandaoqiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
