        ...
        <el-form
            ...
            <input id="jiaolianId" name="jiaolianId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengPhoto" label="课程封面" prop="kechengPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.kechengPhoto?ruleForm.kechengPhoto:''"
                            @change="kechengPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="课程类型" prop="kechengTypes">
                        <el-select v-model="ruleForm.kechengTypes" :disabled="ro.kechengTypes" placeholder="请选择课程类型">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="价格" prop="kechengNewMoney">
                       <el-input v-model="ruleForm.kechengNewMoney"
                                 placeholder="价格" clearable  :readonly="ro.kechengNewMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="价格" prop="kechengNewMoney">
                           <el-input v-model="ruleForm.kechengNewMoney"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="课程简介" prop="kechengContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengContent" label="课程简介" prop="kechengContent">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //图片
            kechengPhotoUploadChange(fileUrls){
                this.ruleForm.kechengPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
