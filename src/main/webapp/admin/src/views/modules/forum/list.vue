            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.jiaolianId">
                            教练
                        </span>
...
|| (sessionTable == 'jiaolian' && scope.row.jiaolianId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zhinengxunlianpingtai/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.huanyuanTypes = el.huanyuanTypes;
                            forum.huiyuandaoqiTime = el.huiyuandaoqiTime;
                            forum.yonghuDelete = el.yonghuDelete;
                            forum.createTime = el.createTime;
                            forum.jiaolianId = el.jiaolianId;//---
                            forum.jiaolianName = el.jiaolianName;
                            forum.jiaolianPhoto = el.jiaolianPhoto;
                            forum.jiaolianPhone = el.jiaolianPhone;
                            forum.jiaolianEmail = el.jiaolianEmail;
                            forum.jiaolianXiangmu = el.jiaolianXiangmu;
                            forum.jiaolianJiangxiang = el.jiaolianJiangxiang;
                            forum.jiaolianContent = el.jiaolianContent;
                            forum.jiaolianDelete = el.jiaolianDelete;
                            forum.createTime = el.createTime;
