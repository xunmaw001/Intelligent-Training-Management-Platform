    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="消费项目" prop="xiaofeijiluName">
                       <el-input v-model="ruleForm.xiaofeijiluName"
                                 placeholder="消费项目" clearable  :readonly="ro.xiaofeijiluName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="消费项目" prop="xiaofeijiluName">
                           <el-input v-model="ruleForm.xiaofeijiluName"
                                     placeholder="消费项目" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="消费金额" prop="xiaofeijiluQian">
                       <el-input v-model="ruleForm.xiaofeijiluQian"
                                 placeholder="消费金额" clearable  :readonly="ro.xiaofeijiluQian"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="消费金额" prop="xiaofeijiluQian">
                           <el-input v-model="ruleForm.xiaofeijiluQian"
                                     placeholder="消费金额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    xiaofeijiluName: false,
                    xiaofeijiluQian: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                ...
                rules: {
                   ...
                   xiaofeijiluName: [
                              { required: true, message: '消费项目不能为空', trigger: 'blur' },
                          ],
                   xiaofeijiluQian: [
                   ...
                   insertTime: [
                              { required: true, message: '消费时间时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xiaofeijilu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xiaofeijiluCrossAddOrUpdateFlag = false;
                                        this.parent.search();
