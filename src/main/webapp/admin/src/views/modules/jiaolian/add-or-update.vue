    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教练姓名" prop="jiaolianName">
                       <el-input v-model="ruleForm.jiaolianName"
                                 placeholder="教练姓名" clearable  :readonly="ro.jiaolianName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiaolianPhoto" label="头像" prop="jiaolianPhoto">
                        <file-upload
                            tip="点击上传头像"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiaolianPhoto" label="头像" prop="jiaolianPhoto">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="jiaolianPhone">
                       <el-input v-model="ruleForm.jiaolianPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.jiaolianPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="jiaolianEmail">
                       <el-input v-model="ruleForm.jiaolianEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.jiaolianEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="邮箱" prop="jiaolianEmail">
                           <el-input v-model="ruleForm.jiaolianEmail"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="擅长项目" prop="jiaolianXiangmu">
                       <el-input v-model="ruleForm.jiaolianXiangmu"
                                 placeholder="擅长项目" clearable  :readonly="ro.jiaolianXiangmu"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="擅长项目" prop="jiaolianXiangmu">
                           <el-input v-model="ruleForm.jiaolianXiangmu"
                                     placeholder="擅长项目" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="获得奖项" prop="jiaolianJiangxiang">
                       <el-input v-model="ruleForm.jiaolianJiangxiang"
                                 placeholder="获得奖项" clearable  :readonly="ro.jiaolianJiangxiang"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="获得奖项" prop="jiaolianJiangxiang">
                           <el-input v-model="ruleForm.jiaolianJiangxiang"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="教练简介" prop="jiaolianContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiaolianContent" label="教练简介" prop="jiaolianContent">
                            <span v-html="ruleForm.jiaolianContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    jiaolianPhone: false,
                    jiaolianEmail: false,
                    jiaolianXiangmu: false,
                    jiaolianJiangxiang: false,
                    jiaolianContent: false,
                    jiaolianDelete: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                ...
                rules: {
                   ...
                   jiaolianJiangxiang: [
                              { required: true, message: '获得奖项不能为空', trigger: 'blur' },
                          ],
                   jiaolianContent: [
