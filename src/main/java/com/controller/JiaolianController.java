...
//                            jiaolianEntity.setJiaolianEmail(data.get(0));                    //邮箱 要改的
//                            jiaolianEntity.setJiaolianXiangmu(data.get(0));                    //擅长项目 要改的
//                            jiaolianEntity.setJiaolianJiangxiang(data.get(0));                    //获得奖项 要改的
