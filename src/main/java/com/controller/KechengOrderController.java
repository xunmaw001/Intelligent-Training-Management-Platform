...
//                            kechengOrderEntity.setKechengOrderTime(sdf.parse(data.get(0)));          //预定时间 要改的
    ...
    */
    ...
    public R add(@RequestBody KechengOrderEntity kechengOrder, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,kechengOrder:{}",this.getClass().getName(),kechengOrder.toString());
            ...
            kechengOrder.setKechengOrderTypes(2); //设置订单状态为已支付
            ...
            xiaofeijiluEntity.setYonghuId(yonghuEntity.getId());
            xiaofeijiluEntity.setXiaofeijiluQian(kechengEntity.getKechengNewMoney());
            xiaofeijiluEntity.setXiaofeijiluName("预约‘"+kechengEntity.getKechengName()+"'");
    ...
    */
    ...
    public R refund(Integer id, HttpServletRequest request){
        ...
        String role = String.valueOf(request.getSession().getAttribute("role"));
            ...
            kechengOrder.setKechengOrderTypes(1);//设置订单状态为退款
            kechengOrderService.updateById(kechengOrder);//根据id更新
